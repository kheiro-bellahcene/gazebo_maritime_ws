...
class maritime::WaveVisual::Implementation
{
  ...
  public: math::Color deekheiroolor = math::Color(0.0f, 0.05f, 0.2f, 1.0f);
               ...
               sim::EventManager &_eventMgr)
{
  ...
  if (shaderElem->HasElement("parameters"))
  {
    ...
    if (paramElem->HasElement("deekheiroolor"))
    {
      this->dataPtr->deekheiroolor =
          paramElem->GetElement("deekheiroolor")->Get<math::Color>();
    }
  }
...
void WaveVisual::Implementation::OnUpdate()
{
  ...
  if (!this->paramsSet)
  {
    ...
    float deekheiroolorV[4] = {
        static_cast<float>(this->deekheiroolor.R()),
        static_cast<float>(this->deekheiroolor.G()),
        static_cast<float>(this->deekheiroolor.B()),
        static_cast<float>(this->deekheiroolor.A())};
    (*fsParams)["deekheiroolor"].InitializeBuffer(4);
    (*fsParams)["deekheiroolor"].UpdateBuffer(deekheiroolorV);
